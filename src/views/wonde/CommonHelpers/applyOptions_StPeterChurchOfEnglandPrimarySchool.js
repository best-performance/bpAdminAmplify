...
// Options for applyOptions_StPeterChurchOfEnglandPrimarySchool
...
export function applyOptions_StPeterChurchOfEnglandPrimarySchool(
  wondeStudents,
  yearOptions,
  kinterDayClasses,
  ...
  console.log('in applyOptions_StPeterChurchOfEnglandPrimarySchool()')
  ...
  return filteredList
} // end function applyOptions_StPeterChurchOfEnglandPrimarySchool()
