...
export async function addWondeIDs(selectedSchool) {
  ...
  wondeStudentsTemp.forEach((student) => {
    ...
    switch (studentKey) {
      case 'ELISHASOURIBIO':
        studentKey = 'ELISHA-LOUISESOURIBIO'
        break
      case 'ELSABOOTH':
        studentKey = 'ELIZABETHBOOTH'
        break
      case 'VICTORIABARROS':
        studentKey = 'VICTORIAPAIVABARROS'
        break
      case 'ABDURREHMANKHAN':
        studentKey = 'ABDERREHMANKHAN'
        break
      case 'ILAYDADANIELLAGIOVETTITEIXEIRA':
        studentKey = 'ILAYDADANIELLATEIXEIRA'
        break
      case 'LEXIEPATERSON':
        studentKey = 'ALEXAPATERSON'
        break
      case 'RAEKELLY':
        studentKey = 'AVA-RAEKELLY'
        break
      case 'BENISANTA':
        studentKey = 'BENJAMINSANTA'
        break
      case 'OFELIAHARTLEY':
        studentKey = 'OPHELIAHARTLEY'
        break
      case 'NAOMIBFLEMONS':
        studentKey = 'NAOMIFLEMONS'
        break
      case 'HANNAMORAWSKA':
        studentKey = 'HANNAMORAWSKA-SZKOLNICKA'
        break
      case 'ARINCLARK':
        studentKey = 'ARINCLARK-FORMICHI'
        break
      case 'SOFIAIDRIS':
        studentKey = 'MARIAMIDRIS'
        break
      case 'SAMBOLT':
        studentKey = 'SAMUELBOLT'
        break
      case 'TEDSTANDING':
        studentKey = 'EDWARDSTANDING'
        break
      case 'ISLA-BELLEVERNON': // student is in Dynamo twice
        studentKey = 'ISLABELLEVERNON'
        break
      case 'LORIBROWN':
        studentKey = 'LORELEIBROWN'
        break
      case 'LOTTIENEWTON':
        studentKey = 'CHARLOTTENEWTON'
        break
      case 'ANAYAMARSHALL':
        studentKey = 'ANAYAMARSHALL-HIBBERT'
        break
      case 'KIROSANOKWURU':
        studentKey = 'KIROSANOKWURU-BARANYAI'
        break
      case 'NONNIELOUWRENS':
        studentKey = 'RHIANNONLOUWRENS'
        break
      case 'TOMSIMON':
        studentKey = 'THOMASSIMON'
        break
      case 'JAKUBIDRIS':
        studentKey = 'ABRAHAMIDRIS'
        break
      case 'KHAMARIGORDONDAVIS':
        studentKey = 'KHAMARIGORDON-DAVIS'
        break
      case 'CONNORBALLARD':
        studentKey = 'CONNORVOGEL'
        break
      case 'LENNYKANTHACK-CHAN':
        studentKey = 'LENNARDKANTHACK-CHAN'
        break
      case 'COLEECKARDT':
        studentKey = 'NICHOLASECKARDT'
        break
      case 'RAFAFERRERTEALE':
        studentKey = 'RAPHAELFERRERTEALE'
        break
      case 'EDDIEMURTAGH':
        studentKey = 'EDWARDMURTAGH'
        break
      case 'ALEXSUMER-ODLE':
        studentKey = 'ALEXANDERSUMER-ODLE'
        break
      case 'TOMMYSIBBERING':
        studentKey = 'THOMASSIBBERING'
        break
      case 'AMARIIPEROUNE':
        studentKey = 'AMARIIEYANOHORNE-PEROUNE'
        break
      case 'RICKYPADAM':
        studentKey = 'RICKINDERPADAM'
        break
      case 'FREDDIEROBINSON':
        studentKey = 'FREDERICKROBINSON'
        break
      case 'JOTSAROYA':
        studentKey = 'INDERJOTSAROYA'
        break
      case 'IA':
        studentKey = 'ALEXANDERSUMER-ODLE'
        break
      case 'CHARLIEMELVILLE-SMITH':
        studentKey = 'CHARLESMELVILLE-SMITH'
        break
      case 'VINNEYEASTER':
        studentKey = 'VINNYEASTER'
        break
      case 'MONTYSHEVLIN':
        studentKey = 'MONTGOMERYSHEVLIN'
        break
      default:
        break
    }
  ...
  uploadedStudents.forEach((student) => {
    ...
    if (!foundWondeStudent) {
      ...
      unMatchedDynamoDBStudents.push({ ...student, key: studentKey, reason: reason })
    } else {
      // The student is uniquely matched to a Wonde student
      // Is the student already in uniqueDynamoDBMap?
      let foundDynamoDBStudent = matchedDynamoStudentsMap.get(studentKey)
